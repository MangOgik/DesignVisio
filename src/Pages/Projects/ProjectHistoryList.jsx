          ...
          emptyText: (
            <div className="flex flex-col justify-center items-center p-36 gap-4">
              ...
              <span className="text-xl text-color-alternative-gray">
                {userProfile.role === "client"
                  ? "You haven't completed any projects yet. Your ongoing projects will appear here once they are finished."
                  : "No completed projects yet. Once your clients finish their projects based on their bookings with you, they will be displayed here."}
              </span>
              {userProfile.role === "client" ? (
                <Button
